class CreatorMailer < Devise::Mailer
  ...
  def confirmation_instructions(record, _opts = {})
    @resource = record
    m = Mandrill::API.new(ENV['mandrill_api_key'])
    m.messages 'send-template', template_name: 'Default',
                                template_content: [
                                ...
                                message: {
                                  ...
                                  global_merge_vars: [
                                    ...
                                    { name: :main_button,
                                      content: render_to_string('devise/mailer/confirmation_instructions').delete("\n")
                                    }
                                  ]
                                }
