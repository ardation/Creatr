...
ActiveRecord::Schema.define(version: 20_140_224_231_227) do
  ...
  add_index 'member_crms', %w(crm_id member_id), name: 'index_member_crms_on_crm_id_and_member_id', unique: true
  ...
  add_index 'people', %w(mobile campaign_id), name: 'index_people_on_mobile_and_campaign_id', unique: true
